...
This file contains essential commands and workflows for developing and maintaining the AI CLI Bridge when working with Claude. Use these instructions to efficiently run quality checks, manage the server, check logs, and run tests.
...
which python
# Should show: .../ai-cli-bridge/.pal_venv/bin/python
```
...
This guide provides everything needed to efficiently work with the AI CLI Bridge codebase using Claude. Always run quality checks before and after making changes to ensure code integrity.